...
export function CreatePromoForm() {
  ...
  return (
    <form action={action} className="mt-3 flex flex-wrap items-end gap-3">
      ...
      <SaveButton label="Add code" pending={pending} state={state} className="rounded-full bg-course px-5 py-2 text-sm font-semibold text-course-contrast disabled:opacity-50" />
    </form>
  );
}
...
export function RainCheckForm() {
  ...
  return (
    <form action={action} className="mt-3 flex flex-wrap items-end gap-3">
      ...
      <SaveButton label="Issue rain check" pending={pending} state={state} className="rounded-full bg-course px-5 py-2 text-sm font-semibold text-course-contrast disabled:opacity-50" />
    </form>
  );
}
