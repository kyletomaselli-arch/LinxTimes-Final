                          ...
                          {s.bookings.map((b) => (
                            <div key={b.id} className="relative">
                              <button onClick={() => setMenu(menu === b.id ? null : b.id)} className="flex w-full items-center gap-1.5 truncate rounded-lg bg-gradient-to-r from-linx-green/10 to-linx-green/5 px-2.5 py-2 text-left text-xs font-semibold border border-linx-green/20 transition hover:bg-linx-green/15 hover:border-linx-green/40">
                                ...
                                {b.withCart ? <><i className="ti ti-car" style={{ fontSize: "12px", marginRight: "2px" }} aria-hidden="true" /><span className="shrink-0 ml-auto text-foreground/70 text-xs">Cart</span></> : <><i className="ti ti-walk" style={{ fontSize: "12px", marginRight: "2px" }} aria-hidden="true" /><span className="shrink-0 ml-auto text-foreground/70 text-xs">Walk</span></>}
